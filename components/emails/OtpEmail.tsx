...
export const OtpEmail: React.FC<Readonly<OtpEmailProps>> = ({
  ...
  <div style={{ fontFamily: "sans-serif", color: "#333", maxWidth: "600px", margin: "0 auto", padding: "20px" }}>
    ...
    <div style={{ textAlign: "center", marginBottom: "30px", backgroundColor: "#f9f9f9", padding: "30px", borderRadius: "12px" }}>
      <h2 style={{ fontSize: "18px", fontWeight: "normal", marginBottom: "15px" }}>
        E-posta Doğrulama Kodunuz
      </h2>
      
      <p style={{ fontSize: "15px", lineHeight: "1.6", color: "#555", marginBottom: "25px" }}>
        İşleminize devam edebilmek için aşağıdaki doğrulama kodunu kullanabilirsiniz. Kodun geçerlilik süresi <strong>3 dakikadır</strong>.
      </p>
    ...
    <p style={{ fontSize: "13px", lineHeight: "1.5", color: "#777", textAlign: "center" }}>
