    ...
    <div className="animate-in fade-in duration-300">
      ...
      {favorites.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
          ...
          <Link
            href="/"
            className="mt-6 bg-black text-white px-8 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest shadow-md hover:bg-gray-800 transition-all"
          >
            Keşfetmeye Başla
          </Link>
        </div>
          ...
          {favorites.map((product) => {
            ...
            return (
              <Link
                ...
                key={product.id}
                className="group relative block w-full h-full flex flex-col border border-gray-100 p-2 rounded-2xl hover:border-black transition-all"
              >
                ...
                <div className="px-1 flex-1 flex flex-col">
                  ...
                  <p className="text-sm font-black text-black mt-auto">
