      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed font-medium">
              Zanaatin, milli değerlerin ve kültürel simgelerin modern dünyayla
              buluştuğu nokta. Ruhun imgelendiği aksesuarlar ve mobilyalar.
            </p>
          ...
          {/* 2. Kurumsal */}
          <div>
            <h3 className="text-sm font-black uppercase tracking-widest mb-6 text-gray-200">
              Kurumsal
            </h3>
          ...
          <div>
            ...
            <div className="p-5 bg-white/5 border border-white/10 rounded-2xl space-y-4">
              ...
              <div className="flex gap-2 pt-2 border-t border-white/10">
                ...
                <div className="w-10 h-6 bg-white/10 rounded flex items-center justify-center text-[8px] font-black">
                  VISA
                </div>
                <div className="w-10 h-6 bg-white/10 rounded flex items-center justify-center text-[8px] font-black">
                  MASTER
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4 text-gray-500">
            <Link
              href="https://instagram.com/prestigeso"
              target="_blank"
              className="hover:text-white transition-colors"
            >
              Instagram
            ...
            <Link
              href="https://twitter.com/prestigeso"
              target="_blank"
              className="hover:text-white transition-colors"
            >
              Twitter
