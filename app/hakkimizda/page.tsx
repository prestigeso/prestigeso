        ...
        <div className="space-y-12">
          ...
          <section>
            <p className="text-lg md:text-xl font-medium text-black leading-relaxed italic border-l-4 border-black pl-5 py-2">
              "Fason üretimin ve el emeği eksikliğinin piyasanın kalitesini
              düşürdüğü bu dönemin aksine; zanaatin öneminin, milli
              değerlerimizin, kültürel simgelerimizin sergilenmesinin öneminin
              farkında olan bir markayız."
            </p>
            <p className="text-sm md:text-base text-gray-600 leading-relaxed mt-6">
              İnsanlara sanatın ve doğal güzelliklerin günlük hayatta yer
              alabileceğini gösterip; aksesuar ve mobilya kategorilerinde ruhun
              daha çok imgelendiği, insanı düşünmeye ve bakarken bir şeyler
              hissetmeye iten bir dünya oluşturmak istiyoruz.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-600 flex flex-col gap-1 mt-2">
                    <a
                      ...
                      className="hover:text-black transition-colors font-bold text-black border-b border-gray-200 w-max pb-0.5"
                    >
                      0553 683 49 97
                    </a>
                    <a
                      href="mailto:counselor@prestigeso.com"
                      className="hover:text-black transition-colors"
                    >
                      counselor@prestigeso.com
                    </a>
                    <a
                      href="mailto:qayzhera@gmail.com"
                      className="hover:text-black transition-colors"
                    >
                      qayzhera@gmail.com
                    </a>
              ...
              <div className="p-6 bg-gray-50 border border-gray-100 rounded-2xl flex flex-col gap-3 md:col-span-2">
                ...
                <div>
                  <h3 className="text-xs font-black uppercase tracking-widest text-black mb-2">
                    Kargo Çıkış Noktalarımız
                  </h3>
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-white border border-gray-200 px-4 py-2 rounded-xl text-xs font-bold text-gray-700">
                      İstanbul, Bağcılar
                    </span>
                    <span className="bg-white border border-gray-200 px-4 py-2 rounded-xl text-xs font-bold text-gray-700">
                      İstanbul, Sultangazi
          ...
          <section className="bg-black text-white p-8 md:p-10 rounded-3xl relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-sm md:text-base leading-relaxed font-medium opacity-90">
                Tecrübeli teknik kadromuz ile güvenilir ve verimli ekip olma
                anlayışıyla; müşteri memnuniyeti ve kalite ile birlikte
                zamanındalık ilkesinden ödün vermeden ülke ve dünya
                standartlarına uygun olarak hizmet sunmaktayız.
              </p>
              <p className="text-sm md:text-base leading-relaxed font-medium opacity-90">
                Hizmet kalitesi ve bunun ile bağlantılı olarak müşteri
                memnuniyetini arttırmaya yönelik çalışmalarımız sürekli olarak
                devam etmektedir. Teknolojinin katkıları ile siz değerli
                müşterilerimize her noktada sorunlarınızı gidermek ve destek
                olmak için durmaksızın çalışıyoruz.
              </p>
            </div>
          </section>
        </div>
